...
MACRO(MYSQL_CHECK_CURL)
  ...
  ELSEIF(WITH_CURL)
    ...
    # CURL depends on SASL2
    FIND_LIBRARY(SASL2_LIBRARY
      NAMES sasl2 libsasl2
      PATHS ${SASL2_LIB_PATH}
      NO_DEFAULT_PATH
      NO_CMAKE_ENVIRONMENT_PATH
      NO_SYSTEM_ENVIRONMENT_PATH
      )
    IF(SASL2_LIBRARY MATCHES "SASL2_LIBRARY-NOTFOUND")
      MESSAGE(FATAL_ERROR "SASL2 library not found under '${SASL2_LIB_PATH}'")
    ENDIF()

    # CURL depends on RESOLV
    FIND_LIBRARY(RESOLV_LIBRARY
      NAMES resolv libresolv
      PATHS ${RESOLV_LIB_PATH}
      NO_DEFAULT_PATH
      NO_CMAKE_ENVIRONMENT_PATH
      NO_SYSTEM_ENVIRONMENT_PATH
      )
    IF(RESOLV_LIBRARY MATCHES "RESOLV_LIBRARY-NOTFOUND")
      MESSAGE(FATAL_ERROR "RESOLV Library not found under '${RESOLV_LIB_PATH}'")
    ENDIF()

    SET(CURL_LIBRARIES ${CURL_LIBRARY} ${NGHTTP2_LIBRARY} ${LIBSSH2_LIBRARY}
      ${KRB5_LDAP_LIBRARY} ${KRB5_LIBRARY} ${KRB5_SUPPORT_LIBRARY}
      ${K5CRYPTO_LIBRARY} ${LDAP_LIBRARY} ${LBER_LIBRARY} ${CARES_LIBRARY}
      ${KEYUTILS_LIBRARY} ${SASL2_LIBRARY} ${RESOLV_LIBRARY} com_err)
  ELSE()
